...
public class ChnlzrConnectionFactoryTest {

  private static class IdleCallback implements FutureCallback<ChnlzrConnectionHandler> {
  ...
  public void testFutureCanceledOnConnectionFailure() throws InterruptedException {
    ...
    final ChnlzrConnectionFactory FACTORY = new ChnlzrConnectionFactory(CONFIG, EmbeddedChannel.class, GROUP);
